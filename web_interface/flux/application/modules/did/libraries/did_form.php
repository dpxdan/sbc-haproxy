...
class did_form extends common
{
	...
	function did_batch_update_form()
	{
		$status = array(
			gettext('Status'),
			array(
		...
		$reverse_rate = array(
			gettext('Reverse Rate'),
			array(
				'name'  => 'reverse_rate[reverse_rate]',
				'id'    => 'reverse_rate',
				'class' => 'reverse_rate',
			),
			'SELECT',
		...
		$bypass_media = array(
			gettext('Bypass Media'),
			array(
				'name'  => 'bypass_media[bypass_media]',
				'id'    => 'bypass_media',
				'class' => 'bypass_media',
			),
			'SELECT',
			...
			'',
			array(
				'name'  => 'bypass_media[operator]',
				'class' => 'update_drp',
			),
			'update_drp_type',
		);
		$form['forms'] = array(
			"did/did_batch_update/",
			array(
				'id' => "did_batch_update",
			),
		);
		$form[gettext('Batch Update')] = array(
			...
			array(
				...
				array(
					...
					'size'      => '20',
					'maxlength' => '180',
					'class'     => "text field extensions_set",
				),
				'',
				'Tool tips info',
				'1',
				array(
					'name'  => 'extensions[operator]',
					'class' => 'update_drp',
				),
				'',
				'',
			...
			array(
				gettext('SIP Profile'),
				array(
					'name'  => 'sip_profile_id[sip_profile_id]',
					'id'    => 'sip_profile_id',
					'class' => 'sip_profile_id',
				),
				'SELECT',
				'',
				'',
