								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class='form-group col-md-3'>
											<label class="control-label p-0"><?php echo gettext('Country')?> </label>
										...
										<div class='form-group col-md-3'>
											<label class="control-label p-0" id="provience" name="provience_didlist_command"><?php echo gettext('Province')?> </label>
										...
										<div class='form-group col-md-3'>
											<label class="control-label p-0" id="city" name="city_didlist_command"><?php echo gettext('City')?> </label>
										...
										<div class='form-group col-md-3'>
											<label class="control-label p-0" id="user_didlist_command" name="user_didlist_command"><?php echo gettext('Available DIDs')?> </label>
