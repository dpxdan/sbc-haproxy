...
class Siprouting_model extends CI_Model
{
    ...
    public function add_sip_device_routing($add_array)
    {
        unset($add_array['id']);
    ...
    public function edit_sip_device_routing($add_array, $edit_id)
    {
        $final_arr = array(
            'sip_device_id'                    => $add_array['sip_device_id'],
            'is_recording'                     => $add_array['is_recording'],
    ...
    public function edit_voice($data, $id)
    {
        unset($data['action']);
    ...
    public function fs_retrieve_sip_user($flag, $start = 0, $limit = 0)
    {
        $deviceinfo = array();
