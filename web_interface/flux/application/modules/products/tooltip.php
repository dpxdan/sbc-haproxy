...
$tooltip_data = array(
	...
	"product_add_form_bypass_media" => "When enabled, media flows directly between endpoints, bypassing FluxSBC. Not available when call recording is active.",
	/*End*/
	...
	"product_edit_form_area_code" => "Area code (DDD) of the number. Used for regional identification of the DID.",

	"product_edit_form_reverse_rate" => "When active, inbound calls to this DID generate charges. Used for numbers with incoming call costs, such as 0800 and similar.",

	"product_edit_form_rate_group" => "Rate group applied when reverse rating is active. Defines the cost charged per call received on this DID.",

	"product_edit_form_bypass_media" => "When enabled, media flows directly between endpoints, bypassing FluxSBC. Not available when call recording is active.",
	/*End*/
);
