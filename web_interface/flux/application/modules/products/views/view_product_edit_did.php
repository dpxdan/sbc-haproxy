  ...
  <div id="floating-label" class="w-section inverse p-0">
    ...
    <div class='col-md-6 form-group'>
        ...
        <div class='col-md-6 form-group'>
                          ...
                          <?php if($product_info['is_recording'] == 0){ ?>
                          <input type="hidden" name="bypass_media" value="1">
                          <select class="col-md-12 form-control selectpicker form-control-lg" disabled='disabled' data-live-search='true' datadata-live-search-style='begins'>
                            <?php } else { ?>
