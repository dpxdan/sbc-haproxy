...
<section class="slice color-three padding-b-20">
	<div id="floating-label" class="w-section inverse p-0">
				...
				<div class="card pb-4 px-0">
					...
					<div  class="row px-4">
						...
						<div class="col-md-12 my-4">
							...
							<div class="col-md-4 float-left">
								<button class="btn btn-success btn-block" id="btnSaveProduct" name="action" value="Save" type="button" onclick="productEditSubmit()"><?php echo gettext('Save'); ?> </button>
							</div>
							<div class="col-md-4 float-left">
		...
		<?php $this->load->view('view_product_conflict_modal'); ?>
...
function productEditSubmit() {
	product_conflict_submit('#product_edit_form', $('input[name="id"]').val(), '#btnSaveProduct');
	}
