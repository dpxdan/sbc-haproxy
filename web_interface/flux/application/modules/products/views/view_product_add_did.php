		...
		<div class='col-md-6 form-group'>
                  ...
                  <div class='col-md-6 form-group'>
                      ...
                      <select  name="bypass_media" class="col-md-12 form-control selectpicker form-control-lg" data-live-search='true' datadata-live-search-style='begins'>
                        <?php if(isset($bypass_media)){ ?>
				<option value="0" <?php if($bypass_media == '0'){ ?> selected="selected" <?php } ?>><?php echo gettext('Enable');?></option>
		                <option value="1" <?php if($bypass_media == '1'){ ?> selected="selected" <?php } ?>><?php echo gettext('Disabled');?></option>
