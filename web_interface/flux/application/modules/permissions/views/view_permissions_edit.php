                            ...
                            <div id="floating-label" class="col-md-12 mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="col-md-12 p-0 control-label">
                                        ...
                                        <select name="login_type"
                                            ...
                                            <option value="<?php echo $permission_type_code; ?>">
                                                <?php echo gettext($permission_name); ?>
                                            </option>
                                            ...
                                            <div id="<?php echo $div_function_name; ?>" class="backgroundfff permission_group" style="display: none;">
                                                ...
                                                <?php foreach ($module_value as $first_sub_module_key => $first_sub_module_value) : ?>
                                                    ...
                                                    foreach ($first_sub_module_value as $sub_module_key => $sub_module_value) :
                                                        ...
                                                        $is_main_checked     = (
                                                            isset($permission_result[$first_sub_module_key][$sub_module_key]['main']) &&
                                                            $permission_result[$first_sub_module_key][$sub_module_key]['main'] == 0
                                                        ) ? 'checked' : '';
                                                    ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <?php for ($i = 0; $i < $array_count; $i++) : ?>
                                                                                <?php if ($sub_module_value[$i] !== 'main') : ?>
                                                                                    ...
                                                                                    $is_checked         = (
                                                                                        isset($permission_result[$first_sub_module_key][$sub_module_key][$sub_module_value[$i]]) &&
                                                                                        $permission_result[$first_sub_module_key][$sub_module_key][$sub_module_value[$i]] == 0
                                                                                    ) ? 'checked' : '';
