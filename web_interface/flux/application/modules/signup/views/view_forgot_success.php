...
if (isset($invoiceconf['website_title']) && $invoiceconf['website_title'] != '') {    
	...
	echo gettext("Forgot Password")." | ".gettext("Flux Telecom - Unindo pessoas e negócios");
}
?>
</title>
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-4">
                    ...
                    <?php
                        ...
                        $flux_err_msg = $this->session->flashdata('flux_signupmsg');
                        if ($flux_err_msg) {
                            echo $flux_err_msg;
                        }
                        ?>
						...
						<div class="w-box dark sign-in-wr box_shadow margin-b-10">
							...
							<a class="col-md-12" style="padding: 0px 0px 20px 0px"
										href="<?php echo base_url(); ?>"> <img
											...
											title='Flux Telecom - Unindo pessoas e negócios'
											alt='Flux Telecom - Unindo pessoas e negócios'
											src="<?php echo base_url(); ?>upload/<?php echo$logo;?>">
							<? }?>	
                            	</a>
