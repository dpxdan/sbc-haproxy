	...
	<?php       
        ...
        $invoiceconf = (array)$invoiceconf->first_row();
				if (isset($invoiceconf['website_title']) && $invoiceconf['website_title'] != '') {    
					...
					echo gettext("OTP Verification")." | ".gettext("Flux Telecom - Unindo pessoas e negócios");
				}
	?>
						...
						<h2 class="text-center">	
							<?php
								...
								<? } else {?> 
										...
										<a class="logo_title" href="<?php echo base_url(); ?>"><img class="mb-2 img-fluid" id="logo" title='Flux Telecom - Unindo pessoas e negócios' alt='Flux Telecom - Unindo pessoas e negócios' src="<?php echo base_url(); ?>upload/<?php echo$logo;?>"></a>
								<? }?>
