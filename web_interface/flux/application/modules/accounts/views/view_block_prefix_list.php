...
<script type="text/javascript" language="javascript">
    ...
    function add_package_pattern() {
        var result    = "";
        var direction = $('input[name="block_direction"]:checked').val() || 'outbound';
        ...
        if (result) {
            $.ajax({
                ...
                data: "prefixies=" + result + "&direction=" + direction,
...
<section class="slice m-0">
    <div class="w-section inverse p-4">
        ...
        <div class="col-12 pb-2">
            <label class="mr-3"><b><?php echo gettext('Direction'); ?>:</b></label>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="block_direction" id="dir_out" value="outbound" checked>
                <label class="form-check-label" for="dir_out"><?php echo gettext('Outbound'); ?></label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="block_direction" id="dir_in" value="inbound">
                <label class="form-check-label" for="dir_in"><?php echo gettext('Inbound'); ?></label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="block_direction" id="dir_both" value="both">
                <label class="form-check-label" for="dir_both"><?php echo gettext('Both'); ?></label>
            </div>
        </div>
