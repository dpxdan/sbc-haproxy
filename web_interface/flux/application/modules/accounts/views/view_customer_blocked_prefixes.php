            ...
            <div class="p-4 col-md-12">
                <div class="col-md-12 p-0">
                    ...
                    <div class="float-left ml-1">
                        <a
                            href='<?php echo base_url() . "accounts/customer_add_manual_blockpatterns/$edit_id/"; ?>'
                            rel="facebox_medium" title="<?php echo gettext('Add Manually'); ?>">
                            <span class="btn btn-line-blue">
                                <i class="fa fa-keyboard-o fa-lg"></i><?php echo gettext('Add Manually'); ?>
                            </span>
                        </a>
                    </div>
...
<? end_extend() ?>
<script type="text/javascript">
    function format_direction_label(value) {
        var map = {
            'outbound': '<?php echo gettext("Outbound"); ?>',
            'inbound':  '<?php echo gettext("Inbound"); ?>',
            'both':     '<?php echo gettext("Both"); ?>'
        };
