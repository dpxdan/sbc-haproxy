                              ...
                              ?>
															...
															echo'<div class="col-md-12 text-center">';?> <?php echo gettext('OR');?> <?php echo '</div>';
																	 ...
																	 <?php if($group_title=="term_and_condition"){ ?>
																	 	...
																	 	<?php } ?>
																	 	<label title="<?php echo str_replace('smtp',"SMTP",gettext($val['comment']));?>" data-toggle="tooltip" data-placement="right" data-html="true" class="p-0 control-label" padding="0 0px 0 15px"><?php echo gettext($val['display_name']);?> <?php echo $val['name'] == 'text' || $val['name'] == 'url' ? "" : "*" ?> </label>
																	 <?php
																			if($val['name']=='tax_type'){
																					$select_array=array();
																					$options =  $this->common->{$val['field_type']}();
																					  $tmp = str_replace("smtp","SMTP",gettext($val["comment"]));
